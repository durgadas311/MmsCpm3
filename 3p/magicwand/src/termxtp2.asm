...
*		     (713)528-5158
*
*	LAST REVISION 11/20/25 by Richard Dean <rwdeane@gmail.com>
*		clone from termxt.asm
*		swap delete keys, allow for faster CPUs  on ESC detect
*	1/23/18 by Douglas Miller <durgadas311@gmail.com>
...
XDELTL	DB	128+'S'	;'F4'	DELETE TO END OF LINE
...
XDELTC	DB	128+'d'	;'DEL'	CHARACTER DELETE
...
TC0:	LHLD	CONIN
	...
	CALL	DCONST	; attempted fix for rc-ez80
	POP	H
