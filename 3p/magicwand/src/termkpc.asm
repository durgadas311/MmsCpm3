...
SUBCTLS EQU	$	;TRANSLATES VALUES 0-1F
	DB	0
	db	0bbh	;BLOCK MARKER
	db	0,0,0,0,0,BELL,0,0
	DB	091h	;LINE FEED
	DB	0
	DB	095h	;FORM FEED
XDCR	DB	084h	;CARRIAGE RETURN
	DB	0,0,0
	DB	0c0h	;FIND-KEY
...
DEFIND	EQU	17	;KEY TO DEFINE SEARCH/REPLACE
	PAGE
...
TCONIN	LHLD	CONIN
	...
	END
		;ROUTINE PROVIDING INDIRECT CALLS
