...
putnode()			/* put netlist node number */ 
	{
...
tbparity(chrentry,xmodbyt)		/*    STK   EPS   PEN */
	CHARDEV *chrentry;	       /* N   0     0	  0  */
	byte *xmodbyt;			/* E   0     1	   1  */
	{				/* O   0     0	   1  */
