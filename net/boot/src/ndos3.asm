...
FCBRR0	equ	33	; offset of RR0 field in FCB (not FCB in MSG)
	...
	org	0
ndos$0	equ	$
bdos$0	equ	ndos$0+0fd00h
bdose	equ	bdos$0+6
next	equ	bdose
scb	equ	ndos$0+0fb00h	; Use abs SCB refs
ermde	equ	scb+09ch+04bh
mltio	equ	scb+09ch+04ah
crusr	equ	scb+09ch+044h
ssrch	equ	scb+09ch+047h
crdrv	equ	scb+09ch+03eh
dmaad	equ	scb+09ch+03ch
vers	equ	scb+09ch+005h

serial:
	dw	CFGTBL	; for easy access during boot
	db	0,0,0,0
start:	jmp	COLDST
