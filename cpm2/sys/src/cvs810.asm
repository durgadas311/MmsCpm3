...
*****					      *****
***** 15-17 = 3 - 2.0 Mbyte partitions	      *****
***** 18-21 = 4 - 0.5 Mbyte partitions	      *****
*****  22   = 1.9 Mbyte partition	      *****
*****					      *****
***************************************************
...
MIXER	DB	15,16,17,18,19,20,21,22
	DS	8 
DRIVE$BASE:
	DB	15,23		; DRIVES 15-22
	DW	MBASE
	DS	28
...
;
	DB	'77314 Corvus Interface (10MB, 8 partitions) v1.201 $'
;
...
DSKBD:
	...
	DB	  0,  73,   0	;  18688   except for a 10 Mbyte
	DB	  0, 137,  48	;  35120   Rev. A drive. Then use
	DB	  0, 201,  96	;  51552   256 for an offset. This
	DB	  0, 217, 208	;  55760   is because pipes are not
	DB	  0, 234,  64	;  59968   available on a Rev. A
	DB	  0, 250, 176	;  64176   drive.
	DB	  1,  11,  32	;  68384
	DB     NB+0,   8, 208
;
;	DISK HEADER BLOCKS
