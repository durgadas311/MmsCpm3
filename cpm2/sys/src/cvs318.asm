...
;
	DB	'77314 Corvus Interface (18MB, 3 partitions) v1.20'
	DW	VERS
	DB	'$'
;
...
DSKBD:
	DB	  0, 08H, 0D0H	;2256
	DB	  0,0C0H, 078H	;49272
	DB	  1,078H, 020H	;96288
	DB     NB+0, 08H, 0D0H
	DB     NB+0, 08H, 0D0H
	DB     NB+0, 08H, 0D0H
	DB     NB+0, 08H, 0D0H
	DB     NB+0, 08H, 0D0H
	DB     NB+0, 08H, 0D0H	; not bootable but system space allocated
;
;	DISK HEADER BLOCKS
;
HRD$BASE:
