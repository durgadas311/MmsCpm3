VERS EQU '3 '		    ;Febuary 24, 1983 mjm
**************** CP/M DISK I/O ROUTINES  **********
**************** 8 USER CONSTELLATION	 **********
...
*****					      *****
***** 15-18 = 4 - 2.8 Mbyte partitions	      *****
***** 19-22 = 4 - 1.3 Mbyte partitions	      *****
*****	23  = 1.1 Mbyte partition	      *****
*****					      *****
***************************************************
...
MIXER	DB	15,16,17,18,19,20,21,22,23
	DS	7 
DRIVE$BASE:
	DB	15,24		; DRIVES 15-23
	DW	MBASE
	DS	28
...
;
	DB	'77314 Corvus Interface (18MB, 9 partitions) v1.20'
	DW	VERS
	DB	'$'
;
...
;
DSKBD:
	DB	  0,008H, 0D0H	;   2256   Use 2256 for an offset
	DB	  0,060H, 0D8H	;  24792   except for a 10 Mbyte
	DB	  0,0B8H, 0E0H	;  47328   Rev. A drive. Then use
	DB	  1,010H, 0E8H	;  69864   256 for an offset. This
	DB	  1,068H, 0F0H	;  92400   is because pipes are not
	DB	  1,092H, 048H	; 102984   available on a Rev. A
	DB	  1,0BBH, 0A0H	; 113568   drive.
	DB	  1,0E4H, 0F8H	; 124152
	DB     NB+2,00EH, 050H	; 134736
;
;	DISK HEADER BLOCKS
;
HRD$BASE:
...
DPB8:	DW	72		; SPT
	...
	DW	0,2		; CKS,OFF
;
;	1060K COMMON DISK (NOT BOOTABLE)
;
DPB9:	DW	72		; SPT
	DB	5,32-1,1	; BSH,BLM,EXM
	DW	265-1,512-1	; DSM,DRM
	DB	11110000B,0	; AL0,AL1
	DW	0,2		; CKS,OFF
PAGE
