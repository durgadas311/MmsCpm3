...
********** MACRO ASSEMBLER DIRECTIVES *************
	TITLE	'CVSTIME2 for 2nd of 2 20meg drives'
...
;
	DB	'20Meg Custom Corvus - 3 partitions CVSTIME2 v1.201 $'
;
