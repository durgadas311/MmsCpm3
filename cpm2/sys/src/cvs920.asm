...
*****					      *****
***** 15-18 = 4 - 3 Mbyte partitions	      *****
***** 19-22 = 4 - 1.4 Mbyte partitions	      *****
*****	23  = 1.2 Mbyte partition	      *****
*****					      *****
***************************************************
...
;
	DB	'77314 Corvus Interface (20MB, 9 partitions) v1.201 $'
;
...
DSKBD:
	...
	DB	  0, 103,  32	;  26400   except for a 10 Mbyte
	DB	  0, 197, 112	;  50544   Rev. A drive. Then use
	DB	  1,  35, 192	;  74688   256 for an offset. This
	DB	  1, 130,  16	;  98832   is because pipes are not
	DB	  1, 174,  96	; 110176   available on a Rev. A
	DB	  1, 218, 176	; 121520   drive.
	DB	  2,   7,   0	; 132864
	DB     NB+2,  51,  80	; 144208
;
;	DISK HEADER BLOCKS
;
HRD$BASE:
...
DPB8:	DW	72		; SPT
	...
	DW	0,2		; CKS,OFF
;
;	2600K COMMON DISK (NOT BOOTABLE)
;
DPB9:	DW	72		; SPT
	DB	5,32-1,1	; BSH,BLM,EXM
	DW	296-1,512-1	; DSM,DRM
	DB	11110000B,0	; AL0,AL1
	DW	0,2		; CKS,OFF
PAGE
