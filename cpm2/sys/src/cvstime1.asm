...
**************** 3 USER CONSTELLATION	 **********

********** MACRO ASSEMBLER DIRECTIVES *************
	TITLE	'CVSTIME1 for 1ST of 2 20meg drives'
...
*****					      *****
***** 15-17 = 3 - 6.3M parts on 1st drive     *****
***** 18-20 = 3 - 6.3M parts on 2nd drive     *****
*****					      *****
***************************************************
...
D1	EQU	090H		; drive 1 select (use when 1st drive is 10M)
D2	EQU	0A0H		; drive 2 select (use when 1st drive is 20M)
...
MIXER	DB	15,16,17,18,19,20
	DS	10
DRIVE$BASE:
	DB	15,21		; DRIVES 15-20
	DW	MBASE
	DS	28
...
;
	DB	'20Meg Custom Corvus - 3 partitions CVSTIME1 v1.201 $'
;
...
;
;	Unless a custom module is being built, always assume a Rev. A
;	drive if you are building a 10 Mbyte module.
;	Every partition should have two tracks of system space allocated
;	which uses 144 sectors, and 12 sectors are used for system overhead.
;
...
;	therefore be 44880-444 or 44436 sectors.
;
...
DSKBD:
	DB	D0+   0,   0,  12
	DB	D0+   0, 201,	0
	DB	D0+NB+1, 146,	0   ; NOT BOOTABLE
	DB	D2+   0,   0,  12
	DB	D2+   0, 201,	0
	DB	D2+   1, 146,	0   ; NOT BOOTABLE

	DB	   NB+0,   0,  12   ; DUMMY ENTRIES
	DB	   NB+0,   0,  12  
	DB	   NB+0,   0,  12
;
;	DISK HEADER BLOCKS
