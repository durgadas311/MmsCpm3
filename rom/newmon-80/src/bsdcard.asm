...
cdi0:	; this could take a long time...  need timeout...
	...
	jz	cdi0		; loop infinitely if just "BUSY"
	dcx	h
	mov	a,h
	ora	l
	jnz	cdi0
...
cdi1:	; done with init
	...
	call	sdcmd
	rc
	lxi	h,cmd58+7 ; OCR 31:24
	mov	a,m
	ani	10000000b	; power-up status
	stc
...
read:
	...
	call	sdcmd
	pop	h
	jc	badblk	; turn off SCS
	lda	cmd17+6
	ora	a
	jnz	badblk	; turn off SCS
