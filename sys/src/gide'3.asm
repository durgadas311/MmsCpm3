...
GIDE$EF	equ	061h	; GIDE feature/error register
GIDE$SC	equ	062h	; GIDE sector count
GIDE$SE	equ	063h	; GIDE sector number	(lba7:0)
GIDE$CL	equ	064h	; GIDE cylinder low	(lba15:8)
GIDE$CH	equ	065h	; GIDE cylinder high	(lba23:16)
GIDE$DH	equ	066h	; GIDE drive+head	(drive+lba27:24)
