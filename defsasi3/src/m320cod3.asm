...
*************************************************************************
	...
	; Static portion - linked to configurable portion.
	MACLIB	Z80
	$*MACRO
	...
	extrn	SDRV0,SCNUM,SMODTB,SDPB,SDPHTB
	public	STHRD,SINIT,SLOGIN,SREAD,SWRIT,SSTRNG
...
SLOGIN:	call	getptr		; set dataptr & ix to current lun data
...
GETCN1: DCR	C
	...
	LDA	SCNUM		; GET CONTROLLER NUMBER
...
initdata:
	lxix	SMODTB		; START OF MODE BYTE TABLE
	lxi	b,modlen
	...
	ani	01100000b
	mov	h,a
	lda	SDRV0+1 	; Get total number of partitions
